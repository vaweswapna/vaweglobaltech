...
export default function Showcase({ items = defaults }) {
  const [a, b, c, d] = items;
  return (
    <section className="relative py-8 md:py-12 bg-[var(--vawe-beige)]/30">
        ...
        <div className="grid  md:grid-cols-12 gap-4 md:gap-6 items-center">
          <div className="md:col-span-5 order-1 md:order-1">
            ...
            <motion.p
              ...
              className="mt-3 text-neutral-700 font-(--font-raleway)"
            >
            ...
            <div className="mt-5 flex gap-3 sm:gap-4">
              <a href="/services" className="glass gradient-border btn-ring px-3 py-2 text-sm sm:px-5 sm:py-3 sm:text-base rounded-full text-neutral-900 font-semibold hover:-translate-y-px transition-all" style={{ borderColor: 'var(--vawe-teal)' }}>
                See Case Studies
              </a>
              <a href="/contact" className="px-3 py-2 text-sm sm:px-5 sm:py-3 sm:text-base  rounded-full text-neutral-900 font-semibold btn-ring hover:brightness-110 transition" style={{ backgroundColor: 'var(--vawe-coral)' }}>
                Start a Project
              </a>
            </div>
          </div>
