                ...
                <li>
                  <Link href="/#services" className="relative inline-block text-sm sm:text-base text-neutral-700 hover:text-[#00448a] transition-colors duration-200 group/link">
                    ...
                    <span className="absolute left-0 right-0 bottom-0 h-0.5 bg-[#00448a] scale-x-0 group-hover/link:scale-x-100 transition-transform duration-200 origin-left" />
							...
							<li>
								<Link href="/blogs" className="relative inline-block text-sm sm:text-base text-neutral-700 hover:text-[#00448a] transition-colors duration-200 group/link">
									<span className="relative z-10">blogs</span>
									<span className="absolute left-0 right-0 bottom-0 h-0.5 bg-[#00448a] scale-x-0 group-hover/link:scale-x-100 transition-transform duration-200 origin-left" />
								</Link>
							</li>
							<li>
								<Link href="/site-map" className="relative inline-block text-sm sm:text-base text-neutral-700 hover:text-[#00448a] transition-colors duration-200 group/link">
