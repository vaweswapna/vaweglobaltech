    ...
    <div className="pt-28">
      <section className="w-full px-6">
        ...
        <motion.p
          ...
          variants={fadeUp}
          custom={0.05}
          className="mt-3 text-neutral-800 max-w-3xl"
        >
          ...
          <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={0.1} className="mt-5">
            <Link
              ...
              className="inline-flex items-center gap-3 px-4 py-2 rounded-md border font-semibold text-black transition"
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            ...
            <article className="md:col-span-2">
              <h2 className="text-2xl font-semibold font-(--font-orbitron)" style={{ color: 'var(--vawe-navy)', borderBottom: '2px solid var(--vawe-teal)', paddingBottom: '8px' }}>About VAWE Institute</h2>
            ...
            {/* Sidebar quick facts */}
            <aside>
              <h3 className="text-lg font-semibold font-(--font-orbitron)" style={{ color: 'var(--vawe-navy)', borderBottom: '2px solid var(--vawe-coral)', paddingBottom: '8px' }}>Contact & Associates</h3>
            ...
            <div className="mt-4">
              <Link href="https://vaweinstitute.com" target="_blank" rel="noopener noreferrer" className="underline text-neutral-900">
                vaweinstitute.com
              </Link>
            </div>
          </aside>
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-6">
            <article>
              <h3 className="text-xl font-semibold font-(--font-orbitron)" style={{ color: 'var(--vawe-navy)', borderBottom: '2px solid var(--vawe-teal)', paddingBottom: '8px' }}>Services Offered</h3>
              <div className="mt-3 rounded-lg overflow-hidden" style={{ border: '2px solid var(--vawe-teal)' }}>
            ...
            <article>
              <h3 className="text-xl font-semibold font-(--font-orbitron)" style={{ color: 'var(--vawe-navy)', borderBottom: '2px solid var(--vawe-coral)', paddingBottom: '8px' }}>Courses</h3>
              ...
              <ul className="mt-3 grid grid-cols-1 gap-2 text-neutral-700">
          ...
          <div className="mt-8 border-t pt-6 grid md:grid-cols-3 gap-6" style={{ borderColor: 'var(--vawe-teal)' }}>
            <article className="md:col-span-2">
              <h3 className="text-xl font-semibold font-(--font-orbitron)" style={{ color: 'var(--vawe-navy)', borderBottom: '2px solid var(--vawe-teal)', paddingBottom: '8px' }}>Why Choose VAWE</h3>
              ...
              <div className="mt-4 grid sm:grid-cols-2 gap-4">
                <ul className="list-disc pl-5 text-neutral-800 space-y-1">
          ...
          <article>
            <h3 className="text-xl font-semibold font-(--font-orbitron)" style={{ color: 'var(--vawe-navy)', borderBottom: '2px solid var(--vawe-coral)', paddingBottom: '8px' }}>Quick Link</h3>
            <Link
              href="https://vaweinstitute.com"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-3 inline-block px-3 py-2 border font-semibold text-white transition"
